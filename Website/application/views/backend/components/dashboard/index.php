...
<div class="content-wrapper">
    ...
    <div class="row">
      ...
      <div class="col-lg-3 col-xs-6">
        ...
        <div class="small-box bg-green">
          ...
          <a href="<?php echo base_url() ?>admin/content" class="small-box-footer">Danh sách bài viết của tin tức</a>
        </div>
      </div>
      <!-- ./col -->
      <div class="col-lg-3 col-xs-6">
        ...
        <div class="small-box bg-yellow">
          ...
          <a href="<?php echo base_url() ?>admin/customer" class="small-box-footer">Liên hệ với khách hàng</a>
        </div>
      </div>
      <!-- ./col -->
      <div class="col-lg-3 col-xs-6">
      ...
      <div class="col-md-12">
        ...
        <div class="box box-info">
          <div class="box-header with-border">
            <h3 class="box-title">Bán hàng & Thống kê</h3>
            ...
            <div class="row">
              <div class="col-sm-4 col-xs-6">
                <div class="description-block border-right">
                  ...
                  <span class="description-text">Tổng thống kê doanh thu</span>
                </div>
                <!-- /.description-block -->
              </div>
              <!-- /.col -->
  ...
  <script>
   ...
   function drawVisualization() {
    ...
    var options = {
      title: 'Số lượng bán ra và đơn hàng từ 01/2024 - 12/2024',
      seriesType: 'bars'
    };
