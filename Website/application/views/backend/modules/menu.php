<aside class="main-sidebar" style="background: #008080;">

    <section class="sidebar" style="background: #008080;">
        <ul class="sidebar-menu" style="background: #008080;">
            <li class="treeview" style="background: #008080;">
                <a href="<?php echo base_url() ?>admin">
                    <i class="fa fa-bar-chart"></i> <span>Thống kê</span>
                </a>
            </li>
            <li class="header">QUẢN LÝ CỦA MOBILE</li>
            <li class="treeview">
            ...
            <li class="header">QUẢN LÝ BÁN HÀNG MOBILE</li>
            <li class="treeview">
                <a href="<?php echo base_url() ?>admin/coupon">
                    <i class="fa fa-diamond"></i> <span>Vourcher</span>
                </a>
            </li>
            <li class="treeview">
