	...
	<div class="container">
		<div class="col-md-7 col-12">
			<div class="section-article contactpage" style="  padding-left: 20px;">
				...
				<form accept-charset="UTF-8" action="<?php echo base_url() ?>lien-he" id="contact" method="post">
					...
					<h1 style="background: #ff0000; color: white; text-align: center; padding: 10px 0; font-size: 20px; font-weight: 500; margin-bottom: 20px;">HÒM THƯ GÓP Ý</h1>				
		...
		<div class="col-md-4 col-12">
			...
			<ul class="list-unstyled">
				<li class="clearfix">
					<i class="fa fa-map-marker fa-1x" style="color:#ff0000; padding: 20px; "></i>
					<span style="color: black">Hồ Sỹ Thịnh - Hồ Chí Minh</span><br>
				</li>
				<li class="clearfix">
					<i class="fa fa-phone fa-1x" style="color:#ff0000;padding: 20px;  "></i>
					<span style="color: black">Hotline: 0368885726</span>
				</li>
				<li class="clearfix">
					<i class="fa fa-envelope fa-1x " style="color:#ff0000; padding: 20px; "></i>
					<span style="color: black"><a href="mailto:alitrumcuoi@gmail.com">sos@gmail.com</span>
				</li>
			</ul>
		</div>
