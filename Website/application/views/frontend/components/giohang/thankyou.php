        ...
        <div class="col-md-12">
            <div class="wrapper overflow-hidden">
                <div class="checkout-content">
                    <div class="tks-header" style="background: #ff0000; color: white; text-align: center; padding: 10px 0; font-size: 18px; font-weight: 500; margin-bottom: 20px;">
                        <h3 class="fa fa-check-circle" style="margin: 0;"> Thông tin đơn hàng đã được gửi đến  
                            <?php 
