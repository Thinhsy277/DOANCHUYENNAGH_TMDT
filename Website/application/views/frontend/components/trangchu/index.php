    ...
    <div class="slider">
        <div class="container">
           <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 list-menu pull-left" style="height: 321px;">
             <img style="width: 100%; height: 160px;" src="public/images/t1.jpg">
             <img style="width: 100%; height: 160px;" src="public/images/t2.jpg">
         </div>
...
<div class="container" style="margin-top: 20px;">
    <div class="sale-title" style="background: #ff0000;">
                ...
                <div class="products-sale">
                    ...
                    <div class="lt-product-group-info">
                        <a href="<?php echo $row['alias'] ?>" title="<?php echo $row['name'] ?>" style="text-align: left;">
                            ...
                            <h5>Cập nhật: <?php echo $row['modified']; ?></h5>
                            <?php
$status_text = ($row['status'] == 1) ? '<span style="color: red;">Còn hàng</span>' : '<span style="color: red;">Hết hàng</span>';
?>

<h5>Tình trạng hàng: <?php echo $status_text; ?></h5>
        ...
        foreach ($listCategory as $rowCategory):
            ...
            if((count($listProducts) >= 3)):?>
                <div class="list-product">
                    <div class="list-header-z" style="background: #ff0000; color: white; text-align: center; position: relative;">
                        <h2 style="color: white !important; margin: 0; padding: 0; width: 100%; text-align: center; position: absolute; left: 0; top: 0; z-index: 2;"><a href="<?php echo  $rowCategory['link']?>" style="color: white !important; text-decoration: none; text-transform: uppercase; font-size: 20px; font-weight: 500; line-height: 40px; display: inline-block;"><?php echo  $rowCategory['name']?> nổi bật</a></h2>
                        <ul class="sub-category" style="position: relative; z-index: 1;">
    ...
    <div class="container">
        <div class="row-p">
            <div class="text-center">
                <h2 class="sectin-title title title-blue" style="color: #ff0000">Tin tức công nghệ</h2>
            </div>
        </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 text-center m-b-xs-10">
                        <div class="service_item">
                            ...
                            <div class="description_icon">
                                <span class="large-text" style="color: #ff0000">
                                    Miễn phí giao hàng
                                </span>
                                <span class="small-text style="color: #ff0000"">
                                    Cho hóa đơn từ 10,000,000đ trở lên
                                </span>
                            </div>
                        </div>
                    </div>
