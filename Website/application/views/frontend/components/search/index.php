            ...
            <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9 product-content">
             <div class="product-wrap">
               <div class="collection__title" style="background: #fff; border: 1px solid #e8e6e2; padding: 0 15px;">
                   <?php
                    echo '<h2 style="font-size: 18px; font-weight: bold; color: #252525; margin: 0; line-height: 40px;">Tìm được '.$count.' kết quả với từ khóa : <span style="color: #ff0000;">'.$key.'</span></h2>';
                    ?>
