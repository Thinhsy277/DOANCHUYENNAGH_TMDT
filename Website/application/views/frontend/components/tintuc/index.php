        ...
        <div class="container">
            ...
            <div class = "col-xs-12 col-sm-12 col-md-9 col-lg-9 product-content" id="list-content">
                <div class="product-wrap">
                  <div class="collection__title" style="background: #fff; border: 1px solid #e8e6e2; padding: 0 15px; margin-bottom: 20px;">
                    <h1 style="font-size: 18px; font-weight: bold; color: #252525; display: inline-block; text-transform: uppercase; margin: 0; line-height: 40px;"><span>Tin tức công nghệ</span></h1>
                  </div>
