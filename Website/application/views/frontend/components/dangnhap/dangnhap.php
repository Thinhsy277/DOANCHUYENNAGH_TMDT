	...
	<div class="products-wrap">
		<div class="container">
			...
			<div class="col-md-6 col-sm-6 col-xs-12">
				<div id="login">
					<div class="acctitle acctitlec" style="background: #ff0000; color: white; text-align: center; padding: 10px 0; font-size: 20px; font-weight: 500; margin-bottom: 20px;">Đăng nhập</div>
					<div class="acc_content clearfix" style="display: block;">
						<form accept-charset="UTF-8" action="" id="customer_login" method="post">
							...
							<div class="col_full nobottommargin">
								...
								<ul class="pull-right">
									<li><a href="<?php echo base_url('quen-mat-khau'); ?>" class="fright">Quên mật khẩu?</a></li>
