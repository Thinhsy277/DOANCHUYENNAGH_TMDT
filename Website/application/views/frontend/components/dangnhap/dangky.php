		...
		<div class="col-md-6 col-sm-6 col-xs-12">
			<div class="products-wrap">
				<div class="accordion accordion-lg divcenter nobottommargin clearfix" style="max-width: 550px;">
					<div id="register">
						<div class="acctitle acctitlec" style="background: #ff0000; color: white; text-align: center; padding: 10px 0; font-size: 20px; font-weight: 500; margin-bottom: 20px;">Đăng ký tài khoản</div>
						<?php 
						if(isset($success))
						...
						<div class="acc_content clearfix" style="display: block;">
							<form accept-charset="UTF-8" action="" id="customer_register" method="post">
								...
								<div class="col_full nobottommargin">
									...
									<ul>
										<li class="right" style="font-size: 18px;">Nếu đã có tài khoản, hãy <a href="<?php echo base_url('dang-nhap'); ?>" style="font-size: 19px; color: #ff0000;">Đăng nhập</a></li>
									</ul>
								</div>
							</form>
						</div>
