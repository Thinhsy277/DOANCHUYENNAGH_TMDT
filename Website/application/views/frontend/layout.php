...
<html lang="en">
  <head>
    ...
    <!-- <link href="public/css/jquery.bxslider.css" rel="stylesheet"> --> <!-- File không tồn tại -->
...
<script async defer crossorigin="anonymous" src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v16.0&appId=955538068812240&autoLogAppEvents=1" nonce="MOZVozY5"></script>
        ...
        <?php 
            ...
            $show_success = !empty($success_message) && ($current_path === '' || $current_path === 'trang-chu');
            $show_error = !empty($error_message) && ($current_path === 'dang-nhap' || $current_path === 'dang-nhap/dangnhap');
        ?>
        <?php if($show_success || $show_error): ?>
            <div class="container" style="margin-top: 15px;">
                <?php if($show_success): ?>
                    <div class="alert alert-success flash-message" style="background:#155724; color:#fff; border:1px solid #0f3f1a; border-radius:4px; padding:12px 15px; margin-bottom:10px;">
                        <?php echo $success_message; ?>
                    </div>
                <?php endif; ?>
                <?php if($show_error): ?>
                    <div class="alert alert-danger flash-message" style="background:#c0392b; color:#fff; border:1px solid #962d22; border-radius:4px; padding:12px 15px;">
        ...
        <!-- Chatbox Widget -->
        <?php $this->load->view('frontend/components/chatbox/chatbox'); ?>
    </body>
</html>
